...
if("TRUE" STREQUAL "TRUE")
  set(rviz_plugins_SOURCE_PREFIX /home/sudaxia/ROSTEMPLATE/HW_2/src/rviz_plugins)
  set(rviz_plugins_DEVEL_PREFIX /home/sudaxia/ROSTEMPLATE/HW_2/devel)
  ...
  set(rviz_plugins_INSTALL_PREFIX /home/sudaxia/ROSTEMPLATE/HW_2/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rviz_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sudaxia/ROSTEMPLATE/HW_2/src/rviz_plugins/${idir}'.  ${_report}")
    endif()
